  ...
  return (
    <div className="w-full flex justify-center flex-col bg-background-dark min-h-screen">
       {/* Hero Section */}
                ...
                <div className="@container">
                    <div className="@[480px]:p-4">
                        <div 
                            ...
                            style={{ backgroundImage: 'linear-gradient(rgba(21, 32, 18, 0.3) 0%, rgba(21, 32, 18, 0.8) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuDvItW7vc6NATP2M7AFyia2lu1sLv1GGyZOGZPtctcpDRbxxdKOPLHVW5Buozj4Kq06PYIDKA-XuTJKQK_GwsP79IXEx7Q4tU8aKNDwT4Y_EoR1e9lUfmOqWDNprxk1wN2xfXG4defBVAn7EaHUSiZs6kUkGPwyKdDqDRo4LJsgzOwM3krLyRV77cXgl8Wz0hrnBb4Dzo34Q4Ggl0N3NU2dmfOC4Ux71ZHcQkOCDpSFkA-pDS4q-djZuWe__QL9oJOHMrqvhWgmblc")' }}
                        >
                            ...
                            <div className="relative flex flex-col gap-4 text-center max-w-[800px]">
                                <span className="text-primary font-bold tracking-widest uppercase text-xs md:text-sm">Establish Your Legacy</span>
                            ...
                            <div className="relative flex gap-4 mt-4">
                                <button className="flex items-center justify-center rounded-full h-12 px-8 bg-primary text-background-dark text-base font-bold tracking-[0.015em] hover:scale-105 transition-transform">
                                    View Our Programs
                                </button>
                            </div>
                        </div>
            ...
            <div className="flex flex-col max-w-[1120px] w-full gap-10 md:gap-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-4 text-text-muted text-lg leading-relaxed">
                            <p>
        ...
        {/* Philosophy Section */}
        <div className="w-full flex justify-center py-12 bg-card-dark/30 border-y border-border-dark/50">
            <div className="w-full flex justify-center px-4 md:px-10">
                <div className="flex flex-col max-w-[1120px] w-full gap-10">
                    <div className="flex flex-col gap-4 text-center items-center">
                        ...
                        <p className="text-text-muted text-base md:text-lg max-w-[720px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Card 1 */}
                        <div className="group flex flex-1 gap-5 rounded-2xl border border-border-dark bg-card-dark p-8 flex-col hover:border-primary/50 transition-colors duration-300">
                            <div className="text-primary bg-primary/10 w-12 h-12 flex items-center justify-center rounded-full group-hover:bg-primary group-hover:text-background-dark transition-colors">
                                <span className="material-symbols-outlined text-3xl">precision_manufacturing</span>
                            </div>
                            <div className="flex flex-col gap-2">
                                <h3 className="text-white text-xl font-bold leading-tight">Technical Mastery</h3>
                        ...
                        <div className="group flex flex-1 gap-5 rounded-2xl border border-border-dark bg-card-dark p-8 flex-col hover:border-primary/50 transition-colors duration-300">
                            ...
                            <div className="flex flex-col gap-2">
                                <h3 className="text-white text-xl font-bold leading-tight">Physical Dominance</h3>
                                <p className="text-text-muted text-sm leading-relaxed">
                        ...
                        <div className="group flex flex-1 gap-5 rounded-2xl border border-border-dark bg-card-dark p-8 flex-col hover:border-primary/50 transition-colors duration-300">
                            ...
                            <div className="flex flex-col gap-2">
                                <h3 className="text-white text-xl font-bold leading-tight">Mental Resilience</h3>
                                <p className="text-text-muted text-sm leading-relaxed">
        ...
        <div className="w-full flex justify-center py-16 px-4 md:px-10">
            <div className="flex flex-col max-w-[1120px] w-full gap-10">
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border-dark pb-6">
                    <div className="flex flex-col gap-2">
                        <span className="text-primary font-bold tracking-widest uppercase text-sm">Leadership</span>
                        <h2 className="text-white text-3xl md:text-4xl font-black leading-tight">Meet The Elite Staff</h2>
                    </div>
                    <p className="text-text-muted max-w-md text-sm md:text-base mb-1">
                        Our coaches are former pros, certified master instructors, and lifelong students of the game.
                    </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* Coach 1 */}
                    <div className="flex flex-col gap-4 rounded-2xl bg-card-dark border border-border-dark p-4 group hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div className="flex flex-col gap-1 px-1">
                            <h3 className="text-white text-lg font-bold">Sarah Jenkins</h3>
                            <p className="text-primary text-sm font-bold uppercase tracking-wide">Director of Pickleball</p>
                            <div className="mt-3 flex flex-wrap gap-2">
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">IPTPA Level II</span>
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">15yrs Pro</span>
                            </div>
                        </div>
                        <button className="mt-2 w-full py-2 rounded-lg bg-background-dark border border-border-dark text-white text-xs font-bold uppercase tracking-wider hover:bg-border-dark transition-colors">
                            View Credentials
                        </button>
                    </div>
                    {/* Coach 2 */}
                    <div className="flex flex-col gap-4 rounded-2xl bg-card-dark border border-border-dark p-4 group hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div className="flex flex-col gap-1 px-1">
                            <h3 className="text-white text-lg font-bold">Marcus Thorne</h3>
                            <p className="text-primary text-sm font-bold uppercase tracking-wide">Senior Head Coach</p>
                            <div className="mt-3 flex flex-wrap gap-2">
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">PPR Certified</span>
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">Natl. Champion</span>
                            </div>
                        </div>
                        <button className="mt-2 w-full py-2 rounded-lg bg-background-dark border border-border-dark text-white text-xs font-bold uppercase tracking-wider hover:bg-border-dark transition-colors">
                            View Credentials
                    ...
                    <div className="flex flex-col gap-4 rounded-2xl bg-card-dark border border-border-dark p-4 group hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div className="flex flex-col gap-1 px-1">
                            <h3 className="text-white text-lg font-bold">Elena Rodriguez</h3>
                            <p className="text-primary text-sm font-bold uppercase tracking-wide">Performance Director</p>
                            <div className="mt-3 flex flex-wrap gap-2">
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">CSCS</span>
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">PhD Kinesiology</span>
                            </div>
                        </div>
                        <button className="mt-2 w-full py-2 rounded-lg bg-background-dark border border-border-dark text-white text-xs font-bold uppercase tracking-wider hover:bg-border-dark transition-colors">
                            View Credentials
                     ...
                     <div className="flex flex-col gap-4 rounded-2xl bg-card-dark border border-border-dark p-4 group hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <div className="flex flex-col gap-1 px-1">
                            <h3 className="text-white text-lg font-bold">David Chen</h3>
                            <p className="text-primary text-sm font-bold uppercase tracking-wide">Strategy Specialist</p>
                            <div className="mt-3 flex flex-wrap gap-2">
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">Data Analyst</span>
                                <span className="inline-flex items-center rounded-md bg-[#2d372a] px-2 py-1 text-xs font-medium text-text-muted ring-1 ring-inset ring-white/10">US Open Gold</span>
                            </div>
                        </div>
                        <button className="mt-2 w-full py-2 rounded-lg bg-background-dark border border-border-dark text-white text-xs font-bold uppercase tracking-wider hover:bg-border-dark transition-colors">
                            View Credentials
        ...
        {/* Facilities Section */}
        <div className="w-full flex justify-center py-16 px-4 md:px-10 bg-gradient-to-b from-transparent to-black/30">
            <div className="flex flex-col max-w-[1120px] w-full gap-8">
                <div className="flex flex-col gap-4 text-center mb-4">
                    <span className="text-primary font-bold tracking-widest uppercase text-sm">Environment</span>
        ...
        <div className="w-full flex justify-center py-12 border-t border-border-dark bg-[#0f140e]">
            <div className="flex flex-col items-center gap-6 max-w-[1120px] w-full px-4">
                <p className="text-text-muted text-sm font-bold tracking-widest uppercase">Certified & Supported By</p>
