      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <button className="flex items-center justify-center h-14 px-8 rounded-full bg-brand-gradient text-white text-lg font-extrabold tracking-wide transition-all hover:scale-105 hover:shadow-xl min-w-[200px]">
              REGISTER FOR TRYOUTS
            </button>
            <Link to="/programs" className="flex items-center justify-center h-14 px-8 rounded-full bg-white/10 text-slate-900 md:text-white border border-white/20 text-lg font-bold tracking-wide transition-all hover:bg-white/20 hover:border-white/40 backdrop-blur-sm min-w-[200px]">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-black text-slate-900 mb-2">500<span className="text-primary">k+</span></p>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-widest">Scholarship Funding</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-black text-slate-900 mb-2">12</p>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-widest">National Titles</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-black text-slate-900 mb-2">24<span className="text-primary">/7</span></p>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-widest">Facility Access</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-black text-slate-900 mb-2">100<span className="text-primary">%</span></p>
              <p className="text-sm font-medium text-slate-500 uppercase tracking-widest">Pro Certified Coaches</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white relative">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Program Card 1 */}
            <div className="group relative overflow-hidden rounded-[2rem] bg-gray-50 border border-gray-200 hover:border-primary/50 transition-colors duration-300">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6">
                <div className="mb-2 inline-flex items-center rounded-full bg-brand-gradient px-3 py-1 text-xs font-bold text-white backdrop-blur-md">
                  AGES 8-12
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Development Squad</h3>
                <p className="text-slate-600 text-sm mb-4 line-clamp-2">Foundational skills, coordination, and game understanding for young aspiring athletes.</p>
                <span className="inline-flex items-center text-primary text-sm font-bold group-hover:text-primary transition-colors">
            ...
            <div className="group relative overflow-hidden rounded-[2rem] bg-gray-50 border border-gray-200 hover:border-primary/50 transition-colors duration-300">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2">High Performance</h3>
                <p className="text-slate-600 text-sm mb-4 line-clamp-2">Intense drilling, strategy sessions, and physical conditioning for tournament preparation.</p>
                <span className="inline-flex items-center text-primary text-sm font-bold group-hover:text-primary transition-colors">
                  Learn More <span className="material-symbols-outlined text-sm ml-1">arrow_outward</span>
                </span>
              </div>
            ...
            <div className="group relative overflow-hidden rounded-[2rem] bg-gray-50 border border-gray-200 hover:border-primary/50 transition-colors duration-300">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Private Instruction</h3>
                <p className="text-slate-600 text-sm mb-4 line-clamp-2">1-on-1 personalized coaching to refine specific mechanics and gameplay weaknesses.</p>
                <span className="inline-flex items-center text-primary text-sm font-bold group-hover:text-primary transition-colors">
                  Learn More <span className="material-symbols-outlined text-sm ml-1">arrow_outward</span>
                </span>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-primary/30 transition-all cursor-pointer shadow-sm">
                ...
                <p className="text-sm text-slate-600">"The coaching here transformed my backhand and mental game entirely."</p>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-primary/30 transition-all cursor-pointer shadow-sm">
                <div className="flex items-center gap-4 mb-3">
                ...
                <p className="text-sm text-slate-600">"Incredible facilities and a community that pushes you to be your best."</p>
              </div>
              <div className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-primary/30 transition-all cursor-pointer shadow-sm">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900">David L.</h4>
                    <p className="text-xs text-primary">U18 Finalist</p>
                  </div>
                </div>
                <p className="text-sm text-slate-600">"The strategic analysis sessions are game-changing. Truly elite level."</p>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] relative shadow-sm border border-gray-100">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">"As a parent investing in my child's future, I couldn't be happier. The disciplined approach and professional environment are unmatched."</p>
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-slate-200 rounded-full flex items-center justify-center text-slate-700 font-bold">JD</div>
                <div>
                  <p className="text-slate-900 font-bold text-sm">James Davidson</p>
                  <p className="text-slate-500 text-xs">Parent of U14 Athlete</p>
                </div>
              </div>
            </div>
            {/* Testimonial 2 */}
            <div className="bg-white p-8 rounded-[2rem] relative shadow-sm border border-gray-100">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">"The level of detail in the coaching is incredible. They don't just teach you how to hit the ball, they teach you how to win."</p>
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-slate-200 rounded-full flex items-center justify-center text-slate-700 font-bold">EP</div>
                <div>
                  <p className="text-slate-900 font-bold text-sm">Elena P.</p>
                  <p className="text-slate-500 text-xs">Professional Player</p>
                </div>
              </div>
            </div>
            {/* Testimonial 3 */}
            <div className="bg-white p-8 rounded-[2rem] relative shadow-sm border border-gray-100">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">"The facilities are pristine and the community is electric. It's the only place I trust for my off-season training."</p>
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-slate-200 rounded-full flex items-center justify-center text-slate-700 font-bold">MR</div>
                <div>
                  <p className="text-slate-900 font-bold text-sm">Marcus Rodriguez</p>
                  <p className="text-slate-500 text-xs">Semi-Pro Athlete</p>
                </div>
              </div>
            </div>
          </div>
